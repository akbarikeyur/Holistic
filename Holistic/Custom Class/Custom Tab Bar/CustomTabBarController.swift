...
class CustomTabBarController: UITabBarController, CustomTabBarViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if #available(iOS 13.0, *) {
            ...
            BLACK_COLOR = UIColor.label
            WHITE_COLOR = UIColor.systemBackground
            GRAY_COLOR = UIColor.systemGray
        } else {
            isDarkMode = false
        }
    }
    ...
    func setup()
    {
        ...
        let navController2 : UINavigationController = STORYBOARD.CLINIC.instantiateViewController(withIdentifier: "ClinicVCNav") as! UINavigationController
        ...
        let navController5 : UINavigationController = STORYBOARD.PRODUCT.instantiateViewController(withIdentifier: "ProductListVCNav") as! UINavigationController
